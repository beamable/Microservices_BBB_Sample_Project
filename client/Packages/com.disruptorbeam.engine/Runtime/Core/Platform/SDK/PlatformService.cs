...
using Core.Platform.SDK.Analytics;
...
using Core.Platform.SDK.Entitlements;
using Core.Platform.SDK.Events;
using Core.Platform.SDK.Groups;
using Core.Platform.SDK.Inventory;
using Core.Platform.SDK.Leaderboard;
using Core.Platform.SDK.Mail;
using Core.Platform.SDK.Matchmaking;
using Core.Platform.SDK.Notification;
using Core.Platform.SDK.Payments;
using Core.Platform.SDK.QA;
using Core.Platform.SDK.Sessions;
using Core.Platform.SDK.Sim;
using Core.Platform.SDK.Social;
using Core.Platform.SDK.Stats;
using Core.Platform.SDK.Tag;
