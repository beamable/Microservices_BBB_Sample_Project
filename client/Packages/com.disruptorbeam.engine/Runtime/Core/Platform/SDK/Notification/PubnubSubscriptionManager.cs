...
using System.Text;
using Core.Platform.SDK.Notification.Internal;
...
namespace Core.Platform.SDK.Notification
{
   /**
      ...
      public void LoadChannelHistory(string channel, int msgLimit, Action<List<object>> onHistory, Action<PubnubClientError> onHistoryError)
      {
         ...
         Action<List<object>> onHistoryUnparsed = response =>
         {
            ...
            foreach (var item in history)
            {
               ...
               object parsedPayload = Core.Serialization.SmallerJSON.Json.Deserialize(messageFull as string);
