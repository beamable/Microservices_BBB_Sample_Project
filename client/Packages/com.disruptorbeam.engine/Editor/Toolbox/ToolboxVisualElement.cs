...
using DisruptorBeam.Editor.Content.UI.ProjectView;
...
namespace DisruptorBeam.Editor.Toolbox

{
...

    {
        ...
        private Promise<string> GetPortalUrl => EditorDisruptorEngine.Instance.Map(de =>
