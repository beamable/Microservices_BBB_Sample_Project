using System.Linq;
using DisruptorBeam.Editor.NoUser;
using UnityEditor;
using UnityEngine;
...
namespace DisruptorBeam.Editor.Content.UI.ProjectView
{
   public class ContentListWindow : EditorWindow
   {
      ...
      public void OnEnable()
      {
         ...
         EditorDisruptorEngine.Instance.Then(de => { de.OnUserChange += _ => Refresh(); });
         Refresh();
      }
      ...
      public async void Publish()
      {
         ...
         if (publishSet.HasValidationErrors(out var errors))
         {
      ...
      public async void DownloadContent()
      {
         ...
         Promise.Sequence(downloadPromises).Then(_ =>
         {
      ...
      {
         return EditorDisruptorEngine.Instance.FlatMap(de =>
