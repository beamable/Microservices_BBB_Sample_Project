...
using DisruptorBeam.Editor.Tests.EditorDisruptorEngine.Content.ContentIOTests;
using DisruptorBeam.Tests;
using NUnit.Framework;
using UnityEngine.TestTools;
using Manifest = DisruptorBeam.Editor.Content.Manifest;

namespace DisruptorBeam.Editor.Tests.EditorDisruptorEngine.Content.ContentPublisherTests
{
   public class CreatePublishSetTests
   {
      ...
      public void Init()
      {
         ...
         _mockContentIo.FetchManifestResult = () => Promise<Manifest>.Successful(new Manifest(_serverContent));
