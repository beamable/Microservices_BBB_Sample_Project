...
using System.Text;
using Core.Platform.SDK; // Promise library
using Core.Serialization.SmallerJSON; // pull into common
using UnityEngine;
...
namespace Beamable.Common.Content
{
   public abstract class ContentSerializer<TContentBase>
   {
      ...
      protected string SerializeArgument(object arg)
      {
         ...
         switch (arg)
         {
            ...
            case IList arr:
               ...
               {
                  var serializedElem = SerializeArgument(elem);
            ...
            default:
               ...
               foreach (var field in fields)
               {
                  ...
                  var fieldJson = SerializeArgument(fieldValue);
      ...
      public List<FieldInfo> GetFieldInfos(Type type)
      {
         ...
         return listOfPublicFields.Union(listOfPrivateFields).ToList();
      }
         ...
         foreach (var kvp in fields)
         {
            ...
            switch (fieldValue)
            {
               ...
               default: // data block.
                  ...
                  var jsonValue = SerializeArgument(fieldValue);
